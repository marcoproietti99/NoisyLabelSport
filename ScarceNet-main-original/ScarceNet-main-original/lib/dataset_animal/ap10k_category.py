...
print("ap10k_category.py is being executed")
data_cfg = dict(
    image_size=[256, 256],
    heatmap_size=[64, 64],
    soft_nms=False,
...
class AnimalAP10KDataset(Kpt2dSviewRgbImgTopDownDataset):
    print("AnimalAP10KDataset constructor called")
    ...
    def __init__(self,
        ...
        logger.info(f"image_set: {image_set}")
        logger.info(f"self.root: {self.root}")
        ...
        if image_set == 'train':
            with open('data_human/label_list/annotation_list_{}'.format(cfg.DATASET.SUPERCATEGORY[0]), 'r') as fp:
